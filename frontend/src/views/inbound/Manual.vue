<template>
  <PageContainer title="手工入库">
    <el-alert title="选择入库单后，录入实际收到的零件数量，系统自动更新入库单状态。" type="info" :closable="false" show-icon style="margin-bottom: 16px" />
    ...
    <el-table :data="tableData" stripe border style="width: 100%">
      ...
      <el-table-column label="操作" width="100" fixed="right">
        <el-button type="primary" link size="small">开始入库</el-button>
      </el-table-column>
    </el-table>
  </PageContainer>
</template>
